const LAYER_RESETS = {
	...
	rf: ["rockets"],
	collapse: ["distance", "velocity", "rank", "tier", "rockets", "rf", "tr", "rea"],
	inf: ["distance", "velocity", "rank", "tier", "rockets", "rf", "tr", "automation", "collapse", "pathogens", "dc", "rea"],
	elementary: [
		"distance",
		"velocity",
		"rank",
...
const LAYER_REQS = {
	rank: ["distance", 10],
	tier: ["rank", 3],
	rockets: ["distance", new ExpantaNum("1e500").mul(DISTANCES.uni)],
	rf: ["rockets", 25],
	collapse: ["distance", 50 * DISTANCES.Mpc],
	inf: ["distance", new ExpantaNum(Number.MAX_VALUE).times(DISTANCES.uni)],
	elementary: [
		["rockets", new ExpantaNum("1e1e1e1e300000")],
		["cadavers", new ExpantaNum("1e1e1e1e30000")],
		["endorsements", "1e1e1e36"]
	],
