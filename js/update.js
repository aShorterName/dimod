...
function setupHTML() {
	...
	span.setHTML((betaID==""&&!window.location.href.includes(correctLink))?"<a href='http://"+correctLink+"/DistInc.github.io/main.html'>this</a> is a link to the main game<br>i sure hope nobody mistakes this for an update...<br>":"")
...
function updateUnlocks() {
	...
	if (player.distance.gte(new ExpantaNum("1e1e9"))) player.tr.unl = true;
